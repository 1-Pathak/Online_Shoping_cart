    ...
    <div class="main-content-wrap">
        ...
        <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data"action="{{ route('admin.product.update') }}">
            ...
            <div class="wg-box">
                ...
                @error('name') <span class="alert alert-danger text-center">{{ $massage }} @enderror
                ...
                @error('slug') <span class="alert alert-danger text-center">{{ $massage }} @enderror
                ...
                <div class="gap22 cols">
                    ...
                    @error('category_id') <span class="alert alert-danger text-center">{{ $massage }} @enderror
                    ...
                    @error('brand_id') <span class="alert alert-danger text-center">{{ $massage }} @enderror
                ...
                @error('short_description') <span class="alert alert-danger text-center">{{ $massage }} @enderror
                ...
                @error('description') <span class="alert alert-danger text-center">{{ $massage }} @enderror
            ...
            <div class="wg-box">
                ...
                @error('image') <span class="alert alert-danger text-center">{{ $massage }} @enderror
                ...
                @error('images') <span class="alert alert-danger text-center">{{ $massage }} @enderror
                ...
                <div class="cols gap22">
                    ...
                    @error('regular_price') <span class="alert alert-danger text-center">{{ $massage }} @enderror
                    ...
                    @error('sale_price') <span class="alert alert-danger text-center">{{ $massage }} @enderror
                ...
                <div class="cols gap22">
                    ...
                    @error('SKU') <span class="alert alert-danger text-center">{{ $massage }} @enderror
                    ...
                    @error('quantity') <span class="alert alert-danger text-center">{{ $massage }} @enderror
                ...
                <div class="cols gap22">
                    ...
                    @error('stock_status') <span class="alert alert-danger text-center">{{ $massage }} @enderror
                    ...
                    @error('featured') <span class="alert alert-danger text-center">{{ $massage }} @enderror
