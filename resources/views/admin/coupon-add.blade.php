    ...
    <div class="main-content-wrap">
        ...
        <div class="wg-box">
            <form class="form-new-product form-style-1" method="POST" action="{{ route('admin.coupon.store') }}">
                ...
                @error('cart') <span class="alert alert-denger text-center">{{ $message }}</span>@enderror 
                ...
                @error('type') <span class="alert alert-denger text-center">{{ $message }}</span>@enderror 
                <fieldset class="name">
                ...
                @error('value') <span class="alert alert-denger text-center">{{ $message }}</span>@enderror 
                <fieldset class="name">
                ...
                @error('cart_value') <span class="alert alert-denger text-center">{{ $message }}</span>@enderror 
                <fieldset class="name">
                ...
                @error('expiry_date') <span class="alert alert-denger text-center">{{ $message }}</span>@enderror 
